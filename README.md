...
- **Najlepsze ułożenie na kierunki DX (dipol, delta pionowa, delta pozioma):** przycisk „policz dla wszystkich kierunków” liczy w NEC-2 warianty anteny dla ośmiu głównych kierunków DX (W1, W6, Karaiby, PY, ZS, VK6, VK2, JA) i pokazuje listę przycisków. Każdy przycisk mówi, z którego masztu (M1–M3; dipol tylko z masztu bez delty, a delta przy wyborze masztu zajętego przez inną antenę pokazuje, co trzeba z niego zdjąć), w jakim układzie pociągnąć drut, jaki średni zysk przy 5–15° daje ten kierunek (z terenem, budynkami, drzewami i stratami w kablu albo eATU) i ile tracimy w zasilaniu. Kliknięcie ustawia antenę w tym układzie i wybiera ten azymut. Dipol: kąt między ramionami 180°, 150°, 120°, 90° i 60° oraz obrót co 5°, oba ramiona muszą się zmieścić w działce. Delta pionowa: dolny drut 1–5 m nad ziemią, trzy punkty zasilania i linia dolnego drutu co 5°, oba narożniki w działce. Delta pozioma: punkt zasilania w każdym z trzech narożników albo na środku każdego boku. Wyniki liczone są bez pozostałych anten na działce; po zmianie pasma, wysokości, gruntu albo kabla lista znika i trzeba ją policzyć jeszcze raz.
...
- **Drzewa:** korony drzew w promieniu 500 m z lidaru GUGiK (pola 5 × 5 m, wyższe niż 3 m, z nierówną powierzchnią, bez budynków i wody), zwykle 5–17 m. W poprawce od otoczenia są częściowo przezroczystymi przeszkodami: strata to mniejsza z dwóch wartości, dyfrakcji na koronie i tłumienia przez pas drzew, przyjętego orientacyjnie na ok. 0,05 dB/m przy 30 MHz i mniej na niższych pasmach. Od tej działki drzewa zasłaniają głównie kierunki zachodnie i południowo-zachodnie (pas przy stawie i rzece, las za dużym stawem), przy 10–15° do kilku dB.
